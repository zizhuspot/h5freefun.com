...
> Freefun is a technology blog that focuses on sharing various interesting topics related to technology, including software development, programming languages, network security, artificial intelligence, and more. Welcome to Freefun and start exploring the endless possibilities of technology!
...
description: Freefun is a technology blog that focuses on sharing various interesting topics related to technology, including software development, programming languages, network security, artificial intelligence, and more. Welcome to Freefun and start exploring the endless possibilities of technology!
keywords:
# 作者名称，会显示在侧边栏
author: FunFun
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/h5freefun.com.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
